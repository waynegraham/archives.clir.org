...
- [The Data Track](#the-data-track)
  ...
  - [7. Identify Migration Formats](#7-identify-migration-formats)
...
_Create macro programs to recode data files._ Given that we could define fairly well the different types of variables in a data set, and that we could create input and recode template statements for these different variable types, it was tempting to think that we would be able to write programs to automate the whole procedure. That is, we might imagine a program that could perform all of the operations described above with minimal effort from the human operators. Although such automation may be possible in the future, the irregularity of the data files presented a major obstacle. Not only would an automatic translation program have to deal with some of the complexities of, for example, split samples with different variable types in the same column, but it would also have to handle the different types of errors that occur in the original data files.
...
_Time and storage requirements of PDF files._ The total time required to process a 39-page document was approximately four hours, from scanning to saving the final PDF. The scanning itself took 30 minutes; the OCR process took 20 minutes; and editing the resulting file took 3 hours 15 minutes. The storage space required for this document is shown in table 5.
...
Spencer, Donald D. 1968. _Computer Programmer’s Dictionary and Handbook_. Waltham, MA: Blaisell Publishing Company.
...
Saffady, William. 1993. _Electronic Document Imaging Systems: Design, Evaluation, and Implementation_. Westport, CT: Meckler Publishing.
...
<tr>
<td></td>
<td>SAS dataset with 3 byte integers (partial set of variables)</td>
<td>3471616</td>
<td></td>
</tr>
<tr>
...
p.                Seeing pornography                           4     None of these  S
                           ...
                           ~  ~TIS-  F~L~ SA77S-      L   BOILZZ17  m&amp;"r

          ~              P14~~ FlED  ~    FIED  Al~Y  M'n



a.  The way things are going for you personally these
...
m.          Thelevelofyour
            ...
            personal debts           1          2          3              4              5              6              7     Y    63/
                               ...
                               as well as its own employees.   Done oniy ty IRS
...
a.                   Shoppingforfood      1            19/          1              2              3              4     Y    21/
...
I'm from The Roper organization and we're conducting a survey about things that are happening today.
...
1.  considering both the availability and cost of things today, as well as your present financial circumstances, do you think
    ...
    now is a good time to buy things you want and need, or a good time~to waitg or is it someplace in between?
...
3.  What is your opinion of most Federal Government departments and agencies? There may be exceptions, of course, but
    ...
    too favorable, or rather 3~favorable?
...
6.  There has been talk about whether some problems in society have more of an impact or less of an impact on racial and
    ...
    ethnic ininori ties than they have on other people.  (USING SAME CARD)  For each one, please tell me if you think it
...
8.                        Of course, the problems we face in  9.  What about drunk driving? (HAND
                          ...
                          our society often have many differ-     RESPONDENT CARD)  Using this

card,

                          ent causes.  I am going to ask you      which three or ifour things do

you

                          about some different problems in        think are the main causes of

people

                          society and for each one I want you     becoming drunk drivers?

                          to tell me what XQIL think are the                                DRUNK

                          major causes of each problem.                                        DRIVING

                          First, violent crime.  (HAND RESPON

                          DENT CARD)  Using this card, which  a. Living inpoverty            1 

 49/

                          three or ifour things do you think  b. Parents not ~eaching
...
2
                                                    ...
                                                    VIOLENT   C. Being abused as a child      
...
b.               Parents not teaching                                                         f. Alackofmorals    6

                  right from wrong                     2                                      g. A lack of education   7

c.               Being abused as a child               3                                      h. A person not seeing any harm in it   .8

d.               Drug abuse                            4                                      i. Apersonbeing irresponsible           9

e.               What people see in TV programs        S

f.               A lack of morals                      6                                      j. Influence of friends  0
...
j.               Influenceof friends                   0                                      1. Whatpeopleseeinmovies Y

k.               Alcohol abuse                                                                m. What people see in advertising       1    50/

1.               What people see in movies                                                    n. Bartenders not being  responsible....2
...
0.                Lowchanceofbeingpunished                      3                        out foreach other    4

p.                seeingpornography                            4                    None of these  S

                  Noneofthese                                  5             4'     Don~tknow      Y

                      ~T  REAL  DIS-        L

                     ~    SATIS- ~  SATIS-  L  BOIL~ ~'T LI~7~~ PLASED FlED  ~ 
...
c.          How President Clinton
            ...
            econ~          1                2             3          4              5              6              7     Y    53/

d.          How Congress is dealing

            withtheeconon~~          1          2          3              4              5              6              7     Y    54/



e.  How your state government is dealing with the

            state's econo~~~               1               2              3              4              5              6              7     Y    55/

f.                Howsecureyour~obis ....l           2          3              4              5              6              7     Y    56/
...
h.  Theamountofyour
            ...
            household income               1               2              3              4              5              6              7     Y    58/

i.          Therateofinflation             1               2              3              4              5              6              7     Y    59/

j.          The amount of taxes

            youpay              1               2          3              4     S             6              7     Y    60

k.          The level of interest

            ra~es          1              2          3          4          S             6                   7     Y    61

1.          The cost and value of

            yourhousing              1          2          3              4              5              6              7     Y    62/
...
m.          Thelevelofyour
            ...
            personal debts           1          2          3              4              5              6              7     Y    63/
                               ...
                               as well as its own employees.   ~one oniy ~y IRS
    ...
    Do you think the IRS should use
                           ...
                           employees?                                          the IRS, would it bother you more to
                             ...
                             Use outside contractors .1     6/                 tractor rather than an IRS employee1
                             ...
                             Doesn't matter (vol.) . .3    900~ type telephone numbers (recordings of music

                                           andmoviestars, ~riviagames, sportsupda~es)          1              2     Y    38/
    ...
    CARD)
                            ...
                            USED IN
                                     ...
                                     6 MONTHS   USEFUL
                                        ...
                                        c.whatotherpeoplehavetoldyouaboutnutritioninfood            ....3                    I    ~

                                        d.Labels on food packages                        4                   I     4

                                            Courses you took in school                   5                    I             s

                                        .'Advertisementsforfoodproducts                                6                   I     6

                                        g.Newspaperarticles                              7                   I     ~
...
61. Of those you have used, which one or two of those sources have you found  as
...
65. Turning to something else. I'd like to talk with you now about games of chance,
    ...
    card, please tell me whether or not you have done it in the past vea.
                                        ...
                                        a.Played games of chance like Bingo sponsored by
                                               ...
                                               church groups, charitable organizations, etc            1              2     Y    501
                                        ...
                                        h.Playednon-legalizednubbersgames                              1               Y    57/

                                        1.Placed sports bets, such as at your place of work,

                                                in a betting parlor. or through a bookie               1              2     Y    58/

    IT~~vTww;~~                         TF~ A~TY I'PEMS CIR~LED IN BOX. ASK 0.66.    I    17q-nI7q-nI

69. Now here is a list of a number' of different things.  (HAND RESPONDENT CARD)

    Would you read down that list and call off each one you personally have done in

    the last week, either at home or at work?
                                                  ...
                                                  f.       Goneintoabank (businessorpersonal)          6
                                                  ...
                                                  r.       Made a long distance phone call (more ~han 100 miles) at home or
...
72. Now I am going to ask you about non-essential spending in different categories. 
    ...
    aren't sure, just guess about how much.  (ASK ABOUT EACH)
                         ...
                         AMOUNT         NONE KNOW
                                          ...
                                          a.   Clothing for adults ... s['[2L]L].00 X    Y    6/7/8/9

                                          b.   Clothing for children . $ L]LIZ]LZ.00     X    Y    10/11/12/13
    ...
    c.   Movies, concerts,
               ...
               e.                        Travel, weekend
                                         ...
                                         getaways          ~ ~ u 0   x    Y    20/21/22/23





    f.   Tapes5 records, CDs,

                                         videos, etc       $ m\~Iffl. 00  X    Y    24/25/26

                                         g.    Things for the home ... $ L]ZJLzL].00     X    Y    27/28/29/30

                    h.                   Reading materials

                                         (books, magazines and      i-lFm~ 00

                                         newspapers)    $ Lififfliffije     X    Y    3~30

I'm going to read a list of some characteristics people might have.  For each one,

would you tell ~rne which you think is ~ important in determining why people are the
...
h.                         Whether someone becomes a great
              ...
              Very liberal                             S    Unemployed              2

              Don't know           Y          Astudent               3     (SKIP
...
D-3. Now here is a list of things                                            some      Skilled and semi-skilled labor                            8
...
year?  (IF eYES")  Which ones?                                        (ASK EVERYONE)
...
g.   Writtenalettertothepaper                     7                                  

divorced or have you never                        been

h.            Signedapetition                     8                                  

married?

i                  Worked forapolitical party              9                              Married                1      (ASK 14/
...
divorce                                            23
                                            ...
                                            Voters, or some other group             Never been married ..      j D-10)

                                            interestedinbetterQovernment .  1  9/                      .      4
...
D-1l.           Are there any children living here                           (HAND RESPONDENT CARD)   Would
...
Age 8 through 12?                  Yes               . 1   No .  2           19/             c.     25 -
...
D-12. Do you own your own home, rent it,
     ...
     your parents or                                   children?                     1.        55 - 59                 9
      ...
      Liveinhomeofchildren .  4            D-17. Now here is a list of                                                                                         income

      Other (vol.)              S                 categories.  (HAND RESPONDENT

                                                           CARD)  Would you call                              off the

D-13. Do you consider yourself the malel         letter of the category that best

     female head of this household                                    or     

     describes the coznbined annual
...
wages or
      ...
      Femalehead              2                 dividends, and all other sources?

      Another adult                               living in

        thehouse               3                a.                                                                           Under$7,000         1
...
D-14. Do you personally do most of the         c.                                                                            $10,000 to $14,999           3
     ...
     hold, or          does        somebody else do most      e.                                         $20,000 to $24,999           S

     of it?                                    f.                                                                            $25,000 to $29,999           6

                                                         g.                          S30,000 to $34,999           7

      Respondent                                    1  23/         h.                            $35,000 to $39,999          8

      Somebodyelse            2                i.                                                                            $40,000 to $49,999           9

      Sharedecually   (vol.) ....  3                1.                                              S50,000 to $74,999                0
...
p, Seeingpornography                 4                 None of these           5
          ...
          UnELY       WHAT REAL  DIS-       L
                     ...
                     ~    SATIS- ~  SATIS-  ~  BoILI~~ ~DT LI~ PIASED FlED ~  FIED
...
m.          Thelevelofyour
            ...
            personal debts           1          2          3              4              5              6              7     Y    63/
                               ...
                               as well as its own employees. Done only by IRS
    ...
    Do you think the IRS should use
                           ...
                           employees?                                         the IRS, would it bother you more to
                             ...
                             Doesn't matter (vol.)   .3    YES")  Which ones?                                       (A~K EVERYONE)
