...
![](/assets/images/reports/pub46/equat3.gif)

incorporates a constant, the enthalpy of activation, ![delta h](/assets/images/reports/pub46/deltah.gif), a thermodynamic function that quantifies the sensitivity of a specific reaction to temperature changes.[2]; ![delta h](/assets/images/reports/pub46/deltah.gif) has a specific value that may be experimentally measured for each paper. Most (of a limited number) of such experimental measurements place ![delta h](/assets/images/reports/pub46/deltah.gif); in the range of 20-35 Kcal (kilocalorie) with a value of 30-35 Kcal providing a very good approximation for most preservation applications.[3]
...
![equiation 4](/assets/images/reports/pub46/equat4.gif)
Equation 4

![equation 5](/assets/images/reports/pub46/equat5.gif)
Equation 5

Using the appropriate environmental values for the T’s and RH’s and an estimated or experimentally determined value for ![delta h](/assets/images/reports/pub46/deltah.gif) these equations can be evaluated algebraically to obtain a quantitative evaluation of permanence changes.
...
![Erratum](/assets/images/reports/pub46/fig1-1.gif)
...
Figures 2 and 3 display a completed array of isoperms for ![delta h](/assets/images/reports/pub46/deltah.gif) values of 25 and 35 Kcal drawn for selected relative permanence values.Other isoperms can be calculated from Equation 5 or are easily estimated by interpolation. It is evident that while the two diagrams are very similar, the 35 Kcal graph shows a greater “sensitivity” to temperature changes. Taken together they both show the importance of using the appropriate ![delta h](/assets/images/reports/pub46/deltah.gif) for a collection.

![Figure 2](/assets/images/reports/pub46/fig2.gif)

Fig. 2. Percent relative humidity versus temperature Isoperm diagram. Permanence
values are calculated for ![delta h](/assets/images/reports/pub46/deltah.gif)= 35 kcal relative to paper at 68 degrees F and 50% RH taken as comparison standard (permanence equal to 1.00). Relative permanence at 95 degrees F and 80% RH is 0.03.

![Figure 3](/assets/images/reports/pub46/fig3.gif)

Fig. 3. Percent relative humidity versus temperature isoperm diagram. Permanence values are calculated for ![delta h](/assets/images/reports/pub46/deltah.gif) = 25 kcal mole -1 relative to paper at 68 degrees F/50% RH taken are reference standard (isoperm equals 1.00).
...
![Figure 4](/assets/images/reports/pub46/fig4.gif)
...
![Figure 5](/assets/images/reports/pub46/fig5.gif)
...
![Figure 6](/assets/images/reports/pub46/fig6.gif)
...
![Figure 7](/assets/images/reports/pub46/fig7.gif)
...
![Equation 2](/assets/images/reports/pub46/equat2a.gif)
...
![](/assets/images/reports/pub46/equatx1.gif)
...
![](/assets/images/reports/pub46/equatx2.gif)
...
More significant is the selection of an appropriate value of ![delta h](/assets/images/reports/pub46/deltah.gif).As can be seen by comparing Figures 2 and 3, the difference between ![delta h](/assets/images/reports/pub46/deltah.gif)'s of 25 and 35 Kcal is substantial, especially for large temperature changes. The 35 Kcal value used in the examples was selected in part because it resulted in larger, more easily recognized differences while still being a value appropriate to many papers. The precise choice of a particular value ![delta h](/assets/images/reports/pub46/deltah.gif) will unquestionably depend in considerable part upon the specific papers in the collection as well as the manner in which they are housed (bound books, boxed manuscripts, newspapers, and so forth). For some of these collections at least, a ![delta h](/assets/images/reports/pub46/deltah.gif) value of 25 Kcal may be more appropriate and the % RH vs T isoperm diagram of Figure 2 may be more appropriate than Figure 3.The numerical values of isoperms discussed in the illustrations of stated paper should not be taken as necessarily the best for all situations. The preservation manager, before making decisions and committing expenditure of funds, should seek the advice of experts or carefully review the most recent literature. Indeed, the need for more specific temperature dependency data has been recognized by the preservation community and proposals have been made to conduct such studies to obtain more information.

While awaiting these studies and expert advice, the preservation manager can explore the preservation consequences using both the 25 and 35 Kcal isoperm diagrams. Such a comparison will show the differences in isoperm value associated with this range of ![delta h](/assets/images/reports/pub46/deltah.gif) values and suggest whether the differences are large enough to significantly affect the manager’s decision.
